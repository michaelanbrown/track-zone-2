...
e1 = Race.create(name: "Boston Marathon", year: 2022, user_id: u1.id, length_id: l1.id)
e2 = Race.create(name: "Run to Feed the Hungry", year: 2018, user_id: u2.id, length_id: l3.id)
e3 = Race.create(name: "Boston Marathon", year: 2022, user_id: u3.id, length_id: l2.id)