...
e1 = Race.create(name: "Boston Marathon", year: 2022, duration: "4:35:58",user_id: u1.id, length_id: l1.id)
e2 = Race.create(name: "Run to Feed the Hungry", year: 2018, duration: "55:23", user_id: u2.id, length_id: l3.id)
e3 = Race.create(name: "Boston Marathon", year: 2022, duration: "38:35", user_id: u3.id, length_id: l2.id)